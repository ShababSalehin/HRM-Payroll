              ...
              <label for="name">Department Name</label>
                <select class="form-control" name="id">
                 ...
                 <?php 
                    ...
                    foreach($departments as $sec){  ?>
                  
                    <option value="{{ $sec->id}}">{{$sec->dept_name}}</option>
                    <?php } } ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="section_name" name="section_name" placeholder="Enter section_name">
                  </div>  
